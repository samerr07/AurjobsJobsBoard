...
//   const requiredSkills = jobDetails?.job_skills_required?.map((skill) => skill).join(', ');
//   const expereniceRequired = `${jobDetails?.job_experience_required} years`;
...
//     const res = await axios.post('http://localhost:3000/api/match/getJobMatch',{candidate,job},{
//       headers: {
...
//     })
//     if(res?.data?.success){
//       console.log(res?.data?.match?.matchScore)
//       setCandidateScore(res?.data?.match?.matchScore)
//     }
//   }
...
//     const isEligible = await aiScreening();
