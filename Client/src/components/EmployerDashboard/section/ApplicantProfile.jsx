...
//         try{
//             const res = await axios.get(`http://localhost:3000/candidates/CandidateProfile/${candidateId}`,{
...
//                                             <h1 className="text-2xl font-semibold text-gray-900">{candidate?.candidate_first_name} {candidate?.candidate_last_name}</h1>
...
//                                         {/* <p className="text-lg text-gray-600 mb-2">{candidate?.candidate_current_role
//                                         } at {candidate.company}</p> */}
