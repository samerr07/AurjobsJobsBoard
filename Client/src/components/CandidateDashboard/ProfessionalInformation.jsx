            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {isEditing ? (
                        <>
                            ...
                            <input
                                ...
                                value={candidateData.candidate_preferred_role}
                                onChange={handleInputChange}
                                className="w-full px-4 py-3 rounded-lg border-2 border-gray-200 bg-white 
               focus:border-blue-500 focus:ring-2 focus:ring-blue-200 
               group-hover:border-blue-300 transition-all duration-300 ease-in-out"
                        ...
                        <div className="py-3">
                            ...
                            <p className="mt-1 text-gray-900">{candidateData.candidate_preferred_role || 'Not provided'}</p>
                        </div>
                    )}
                </div>
                    ...
                    {isEditing ? (
                        <>
                            ...
                            <input
                                ...
                                value={candidateData.candidate_expected_salary}
                                onChange={handleInputChange}
                                className="w-full px-4 py-3 rounded-lg border-2 border-gray-200 bg-white 
               focus:border-blue-500 focus:ring-2 focus:ring-blue-200 
               group-hover:border-blue-300 transition-all duration-300 ease-in-out"
                        ...
                        <div className="py-3">
                            ...
                            <p className="mt-1 text-gray-900">
                                {candidateData.candidate_expected_salary
                                    ? `$${Number(candidateData.candidate_expected_salary).toLocaleString()}`
                                    : 'Not provided'}
                            </p>
                        </div>
                    )}
               ...
               group-hover:border-blue-300 transition-all duration-300 ease-in-out"
                        ...
                        <div className="py-3">
                            ...
                            <p className="mt-1 text-gray-900">{candidateData.candidate_industry_preference || 'Not provided'}</p>
                        </div>
                    )}
                </div>
            </div>
